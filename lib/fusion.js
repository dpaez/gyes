 ...
 * @private
 */
Fusion.prototype.setup = function setup(){
 ...
 * @public
 */
Fusion.prototype.fuse = function fuse( anInterpretation ){
 ...
 * @private
 */
Fusion.prototype.launchMultipleListeners = function launchMultipleListeners( anInterpretation ){
  var self = this;
 ...
 * @private
 */
Fusion.prototype.onEvent = function onEvent( eventName ){
 ...
 * @private
 */
Fusion.prototype.onSignal = function onSignal( data ){
