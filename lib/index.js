...
Gyes.prototype.connect = function connect( uri, opts ){
  return this.io.connect( uri, opts );
};

Gyes.prototype.authenticate = function authenticate( key ){
  this.io.emit( 'authenticate', { token: key } );
};

Gyes.prototype.addModality = function addModality( app_key, aModality ){
...
Gyes.prototype.isValidModality = function isValidModality( aModality ){
 ...
 * @private
 */
Gyes.prototype.emitSignal = function emitSignal( data ){
 ...
 * @private
 */
Gyes.prototype.emitInterpretation = function emitInterpretation( interpretation ){
 ...
 * @private
 */
Gyes.prototype.distributedInterpretation = function distributedInterpretation( data ){
 ...
 */
Gyes.prototype.newModality = function newModality( data ){
 ...
 * @private
 */
Gyes.prototype.newSignal = function newSignal( data ){
